...
var albumAdele = {
    ...
    label: 'XL Recordings',
    year: '2015',
    albumArtUrl: 'assets/images/album_covers/adele.jpg',
    songs: [
        { title: 'Hello', duration: '5:55' },
        { title: 'Send My Love', duration: '3:43' },
        { title: 'I Miss You', duration: '5.48'},
        { title: 'When We Were Young', duration: '4:50' },
        { title: 'Remedy', duration: '4.00'}
    ]    
};
...
var getSongItem = function (element) {
    switch (element.className) {
        ...
        case 'song-item-number':
            return element;
        default:
            console.log("getSongItem does not match any of the expected elements");
            return;
    }  
};
...
collectionContainer[0].addEventListener("click", function(event) {
    if(prevAlbum == 0) {    
      setCurrentAlbum(albumAdele);
        prevAlbum++;
    } else if (prevAlbum == 1) {
